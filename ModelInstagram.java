...
public class ModelInstagram {
    ...
    public ModelInstagram(String userPost, String fotoPost, String captionPost, int likePost, ArrayList komenPost,
            String linkPost) {
        this.user = userPost;
        this.foto = fotoPost;
    ...
    public void post() {
        ...
        System.out.println("[1]Like: " + this.like + "  [2]Comment: " + this.komen.size() + "  [3]Show Comment"
                + "  [4]Copy Link");
        System.out.println();
    }
